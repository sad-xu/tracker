    ...
    !function() {
			...
			_.throttle = function(e, t, r) {
				...
				return function() {
					...
					return s = this,
					n = arguments,
					d <= 0 || d > t ? (i && (clearTimeout(i), i = null), o = u, a = e.apply(s, n), i || (s = n = null)) : i || r.trailing === !1 || (i = setTimeout(c, d)),
					a
				}
			},
			...
			_.base64Encode = function(e) {
				...
				i = c >> 6 & 63,
				o = 63 & c,
				f[p++] = u.charAt(n) + u.charAt(a) + u.charAt(i) + u.charAt(o);
				while (d < e.length);
			...
			_.UUID = function() {
				...
				r = function(e) {
					...
					a = [],
					i = 0;
					for (r = 0; r < n.length; r++) s = n.charCodeAt(r),
					a.unshift(255 & s),
					a.length >= 4 && (i = t(i, a), a = []);
					return a.length > 0 && (i = t(i, a)),
					i.toString(16)
				};
				return function() {
			...
			_.addEvent = function() {
				...
				function t(t, r, s) {
					var n = function(n) {
						if (n = n || e(window.event)) {
							...
							var a, i, o = !0;
							return "function" == typeof s && (a = s(n)),
							i = r.call(t, n),
							!1 !== a && !1 !== i || (o = !1),
							o
						}
				...
				var r = function(r, s, n) {
					...
					if (r && r.addEventListener) r.addEventListener(s,
					function(t) {
			...
			_.cookie = {
				...
				set: function(e, t, r, s, n) {
					...
					n && (o = "; secure"),
					document.cookie = e + "=" + encodeURIComponent(t) + i + "; path=/" + a + o
				},
				remove: function(e, t) {
			...
			_.getEleInfo = function(e) {
				...
				var n = "";
				return t.textContent ? n = _.trim(t.textContent) : t.innerText && (n = _.trim(t.innerText)),
			...
			_.getURLSearchParams = function(e) {
				...
				r = {},
				s = e.substring(1), n = s.split("&"), a = 0; a < n.length; a++) {
					var i = n[a].indexOf("=");
					if (i !== -1) {
			...
			_.trackLink = function(e, t, r) {
				...
				r = r || {},
				!(!n || "object" != typeof n) && (!n.href || /^javascript/.test(n.href) || n.target || n.download || n.onclick ? (sd.track(t, r), !1) : (e.event && s(e.event), void(e.ele && _.addEvent(e.ele, "click",
				function(e) {
					s(e)
				}))))
			}
		...
		sd.initPara = function(e) {
			...
			n), sd.para.use_client_time = !0) : "object" == typeof sd.para.batch_send && (sd.para.use_client_time = !0, sd.para.batch_send = _.extend({},
			n, sd.para.batch_send)) : sd.para.batch_send = !1;
			...
			if (
				"object" == typeof sd.para.source_type && (sd.para.source_type.utm = _.isArray(sd.para.source_type.utm) ? sd.para.source_type.utm.concat(a) : a, 
				...
				_.isObject(sd.para.heatmap) && (sd.para.heatmap.clickmap = sd.para.heatmap.clickmap || "default", 
				...
				for (s = 0; s < sd.para.server_url.length; s++) {
				 /sa\.gif[^\/]*$/.test(sd.para.server_url[s]) || 
					(sd.para.server_url[s] = sd.para.server_url[s].replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2"));
				}
			} else {
		...
		sd.debug = {
			...
			apph5: function(e) {
				...
				n = e.step,
				a = e.data;
				"all" !== s && "console" !== s || sd.log(r[n]),
				("all" === s || "code" === s) && _.isObject(sd.para.is_debug) && sd.para.is_debug.apph5 && (a.type && "profile" === a.type.slice(0, 7) || (a.properties._jssdk_debug_info = "apph5-" + String(n)))
			}
		};
		var commonWays = {
			...
			autoTrack: function(e, t) {
				...
				sd.is_first_visitor && !e.not_set_profile && (
		...
		sd.quick = function() {
			...
			return "string" == typeof t && commonWays[t] 
				...
				: void("function" == typeof t ? t.apply(sd, r) 
		...
		sd.getPresetProperties = function() {
			...
			var t = {
				...
				$referrer_host: _.getHostname(document.referrer),
				$url: location.href,
				$url_path: location.pathname,
				$title: document.title || "",
		...
		BatchSend.prototype = {
			...
			sendPrepare: function(e) {
				...
				else for (var n = 0; n * r < s; n++) this.send({
		...
		sendState.getSendCall = function(e, t, r) {
			...
			var s = e;
			if (
				e = JSON.stringify(e), this.requestData = {
					data: s,
					config: t,
					callback: r
				},
			...
			if (
				...
				if (/sensors-verify/.test(navigator.userAgent)) {
					...
					if (a && a[0] && "string" == typeof a[1] && 2 === a[1].split("?").length) {
						...
						o = null;
						try {
							i = _.URL(sd.para.server_url).hostname,
							o = _.URL(sd.para.server_url).searchParams.get("project") || "default"
						} catch(c) {}
						i && i === a[0] && o && o === a[1] 
						? (
							n = document.createElement("iframe"), 
							n.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({
								server_url: sd.para.server_url
							}, s)))), 
						document.documentElement.appendChild(n), 
						n.parentNode.removeChild(n), 
						n = null, "function" == typeof r && r()) : (sd.debug.apph5({
							data: s,
							step: "3.2",
							output: "all"
						}), this.prepareServerUrl())
		...
		saEvent.send = function(e, t) {
			...
			|| (r.properties = _.extend(
				...
				&& (r.properties.$latest_traffic_source_type = "\u53d6\u503c\u5f02\u5e38"), 
		...
		heatmap = sd.heatmap = {
			...
			getDomIndex: function(e) {
				...
				n = 0; n < s.length; n++) if (s[n].tagName === r) {
					if (e === s[n]) return t;
					t++
				}
				return - 1
			...
			start: function(e, t, r, s, n) {
				...
				"a" === r 
				&& sd.para.heatmap 
				&& sd.para.heatmap.isTrackLink === !0 
				? _.trackLink({
					event: e,
					target: t
				},"$WebClick", c) 
				: sd.track("$WebClick", c, i)
			},
			...
			initScrollmap: function() {
				...
				var e = function(e) {
					...
					t.go = function(e) {
						...
						this.inter 
						|| (
							r.$viewport_position = document.documentElement 
							&& document.documentElement.scrollTop 
							|| window.pageYOffset 
							|| document.body.scrollTop 
							|| 0, 
							r.$viewport_position = Math.round(r.$viewport_position) 
							|| 0, 
							r.$viewport_height = window.innerHeight 
			...
			prepare: function(e) {
				...
				r && r[0] && r[1] ? (
					...
					&& (n && n[0] && n[1] && sessionStorage.setItem("sensors_heatmap_url", decodeURIComponent(n[1])), sessionStorage.setItem("sensors_heatmap_id", r[1]), s && s[0] && s[1] ? "1" === s[1] || "2" === s[1] || "3" === s[1] ? (s = s[1], sessionStorage.setItem("sensors_heatmap_type", s)) : s = null: s = null !== sessionStorage.getItem("sensors_heatmap_type") ? sessionStorage.getItem("sensors_heatmap_type") : null), t(r[1], s)) 
		...
		if (sd.init = function(e) {
			function t() {
				...
				sd.getAppStatus = function(e) {
					return r(),
					t(),
					e ? void(null === s ? n = e: (e(s), s = null)) : s
				}
			}
			return 
				!(
				...
				(
					...
					void heatmap.prepare(function() {
						...
						sd.para.is_track_single_page && _.addSinglePageEvent(function(e) {
							var t = function(t) {
								t = t || {},
								e !== location.href && sd.quick("autoTrack", _.extend({
									$url: location.href,
									$referrer: e
								},
								t))
